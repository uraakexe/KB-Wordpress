...
if(! defined('DEBUG_LEVEL') )				define ('DEBUG_LEVEL', 0);								// Debug level 1 is less noisy and 3 is the most noisy
...
if(! defined('FILE_CACHE_MAX_FILE_AGE') ) 	define ('FILE_CACHE_MAX_FILE_AGE', 31557600);				// How old does a file have to be to be deleted from the cache
